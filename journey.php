...
?>
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row" style="background-color: black;">
                <div class="col-lg-12 img">
                    <img src="img/journey.jpg" alt="" class="img-fluid">
                </div>
            </div>
    ...
    <section class="streamline p-4">
        <div class="container">

            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <h3>
                        Streamlined Journey Management, Reimagined Efficiency
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center pt-2">
                    <div>
                        <p class="" style="text-align: center !important; line-height: 40px;">
    ...
    <section class="real-time" style="background-color: navy;">
        <div class="container p-5">
            ...
            <center>
                <button class="req-btn px-4 py-3 me-3 mt-4" style="background-color: yellow; border: 1px solid lightgray; border-radius: 5px;">
                        <a href="crm.php" style="color: navy; font-family: 'Montserrat', sans-serif;">Request Demo</a>
                </button>
           </center>
    ...
    <section class="safety-app py-5 pb-5">
        <div class="container">
          ...
          <!-- Enhanced Safety and Efficiency -->
            <div class="row pt-5">
                ...
                <div class="col-lg-6 d-flex justify-content-center">
                    <img src="/img/journey-dash-removebg-preview.png" alt="" class="img-fluid">
                </div>
    ...
    <section class="our-panic p-4 shadow-lg" style="background-color: navy;">
